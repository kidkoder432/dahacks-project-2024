...
const ZoomableEarth = forwardRef((_, ref) => {
  ...
  return (
    <>
      ...
      {markerPosition && <Marker position={markerPosition} />} {/* Render the marker if position is set */}
    </>
  );
});
...
function App() {
  ...
  const handleStarsInMyArea = () => {
    alert("Fetching stars in your area!"); // Replace with your actual logic to fetch stars
  };
  ...
  return (
    <>
      ...
      <div style={{
        ...
        <h2 style={{ margin: "0 0 20px 0", textAlign: "center", fontSize: "28px" }}>OnlyStars</h2>
        ...
        {latLng && (
          <div style={{ textAlign: "center", color: "white", fontSize: "18px", marginBottom: "10px" }}>
            Latitude: {latLng.latitude.toFixed(4)}<br />
            Longitude: {latLng.longitude.toFixed(4)}<br />
        ...
        {latLng && ( // Only show this button if latLng is set
          <button onClick={handleStarsInMyArea} style={{
            border: "none",
            borderRadius: "5px",
