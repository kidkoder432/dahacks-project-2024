...
if alt.degrees > 45:
    print(f"The constellation {df.loc[50, 'constellation']} is currently visible in the sky!")
else:
    print(f"The constellation {df.loc[50, 'constellation']} is not currently visible in the sky.")